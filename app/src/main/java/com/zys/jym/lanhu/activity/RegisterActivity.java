...
public class RegisterActivity extends BaseActivity implements View.OnClickListener {
    String TAG="TAG--RegisterActivity";
...
//        index_toolbar.inflateMenu(R.menu.menu_login);
        ...
        switch (view.getId()){
            case R.id.btn_next:
                ...
                if(!MyUtils.isPhoneNumber(et_phone.getText().toString().trim())){
                    MyUtils.showToast(RegisterActivity.this,"手机号码格式不正确");
                    return;
                }
                postData();
            break;
    ...
    private void postData() {
        MyUtils.showDialog(RegisterActivity.this,"发送中...");
        OkHttpUtils
                .post()
                .tag(this)
                ...
                .execute(new SMSCallback() {
                    ...
                    public void onError(Call call, Exception e) {
                        ...
                        MyUtils.showToast(RegisterActivity.this, "连接服务器失败，请稍后再试");
                    }
                    ...
                    public void onResponse(SMSData mData) {
                        ...
                        if (mData.errcode==1){
                            ...
                            MyUtils.showToast(RegisterActivity.this,mData.errmsg);
