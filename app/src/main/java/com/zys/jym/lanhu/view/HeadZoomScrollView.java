...
public class HeadZoomScrollView extends ScrollView {
    ...
    private OnRefListener listener=null;
    boolean canListener=false;
    //    是否正在放大
...
//                MyUtils.Loge("TAG--HeadZoomScrollView","offsetY="+offsetY);
                if (!mScaling) {
                    if (getScrollY() == 0) {
...
//        MyUtils.Loge("TAG--HeadZoomScrollView","scaleTimes="+scaleTimes);
...
//        设置控件水平居中
    ...
    public static abstract class OnRefListener {
        /**
         * 支付成功
         */
