...
public class GroupRvAdapter extends RecyclerView.Adapter <GroupRvAdapter.MyViewHolder>{
    ...
    Context context;
    public GroupRvAdapter(Context context, List<TopData> list) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        MyViewHolder holder = new MyViewHolder(inflater.inflate(R.layout.item_lv_group, parent,
                false));
        return holder;
    }
